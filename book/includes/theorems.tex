...
\declaretheorem[style=infdescimptthm, numberwithin=section, Refname={Solution,Solutions}, name=Solution]{solutions}
% \declaretheorem[style=infdescimptthm, sibling=theorem, Refname={Solution,Solutions}, name={Solution\assumesAC{thmcolac}}]{solutionac}
% \declaretheorem[style=infdescimptthm, numberwithin=chapter, Refname={Solution,Solutions}, name=Solution]{chsolution}
% \declaretheorem[style=infdescimptthm, sibling=theorem, refname={solution,solutions}, Refname={Solution,Solutions}, name=Solution]{isolution}
\declaretheorem[style=infdescimptthm, numbered=no, refname={solution,solutions}, Refname={Solution,Solutions}, name=Solution]{solutions*}
% \declaretheorem[style=infdescimptthm, sibling=theorem, refname={solution,solutions}, Refname={Solution,Solutions}, name={\optmark{Solution}}]{osolution}
