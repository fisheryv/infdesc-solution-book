...
\declaretheoremstyle[
    spaceabove=10pt,
    spacebelow=10pt,
    headfont={\color{solcol}\fontfamily{bch}\bfseries},
    headpunct={{\par\nobreak}\\},
    notefont={\mdseries},
    notebraces={(}{)},
    bodyfont={\fixthmbox\normalfont},
    mdframed={backgroundcolor=solbgcol, linecolor=solbdcol, linewidth=\thmboxborderwidth}, 
]{infdescsolution}
...
\declaretheorem[style=infdescsolution, numberwithin=section, Refname={Solution,Solutions}, name=Solution]{solutions}
% \declaretheorem[style=infdescsolution, sibling=theorem, Refname={Solution,Solutions}, name={Solution\assumesAC{thmcolac}}]{solutionac}
% \declaretheorem[style=infdescsolution, numberwithin=chapter, Refname={Solution,Solutions}, name=Solution]{chsolution}
% \declaretheorem[style=infdescsolution, sibling=theorem, refname={solution,solutions}, Refname={Solution,Solutions}, name=Solution]{isolution}
\declaretheorem[style=infdescsolution, numbered=no, refname={solution,solutions}, Refname={Solution,Solutions}, name=Solution]{solutions*}
% \declaretheorem[style=infdescsolution, sibling=theorem, refname={solution,solutions}, Refname={Solution,Solutions}, name={\optmark{Solution}}]{osolution}
...
\declaretheorem[style=infdescchapex, numberwithin=section, refname={question, questions}, Refname={Question, Questions}, name={}]{chapex}
