...
\ifnumequal{\value{bookformat}}{0}{%
    ...
    \renewcommand{\watermarkh}{6in}
    \renewcommand{\watermarkv}{9in}
    \hypersetup{pdfpagelayout={TwoPageRight}}
}

% Print version (7x10 on letter paper, with crops)
\ifnumequal{\value{bookformat}}{100}{%
    ...
    \setlength{\leftmarginii}{0.25in}
    \setlength{\leftmarginiii}{0.25in}
    \renewcommand{\watermarkh}{7.25in}
...
% Solution
\definecolor{solcol}{HTML}{003300}
\definecolor{solcolac}{HTML}{99FF99}
\definecolor{solbdcol}{HTML}{82B366}
\definecolor{solbgcol}{HTML}{D5E8D4}
