...
% Use this command when a term or spelling is different in British English (en_GB) or US English (en_US) - which spelling appears is set by the 'englishvariant' counter in the root document
\newcommand{\gbus}[2]{%
\ifnumequal{\value{englishvariant}}{0}{#1}{}% en_GB spelling or term
\ifnumequal{\value{englishvariant}}{1}{#2}{}% en_US spelling or term
}