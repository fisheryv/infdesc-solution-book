...
\begin{solutions*}
    Based on the remainder when the integer $n$ is divided by $3$, all integers can be partitioned into three subsets (equivalence classes).
    \begin{align*}
        N_0 &= \{3k \mid k \in \mathbb{Z}\}\\
        N_1 &= \{3k+1 \mid k \in \mathbb{Z}\}\\
        N_2 &= \{3k+2 \mid k \in \mathbb{Z}\}
    \end{align*}
    \begin{align*}
        N_0^2 = (3k)^2 = 9k^2 &= 3 \cdot (3k^2)\equiv 0 \pmod 3 \\
        N_1^2 = (3k+1)^2 = 9k^2 + 6k + 1 &= 3 \cdot (3k^2 + 2k) + 1 \equiv 1 \pmod 3 \\
        N_2^2 = (3k+2)^2 = 9k^2 + 12k + 4 &= 3 \cdot (3k^2 + 4k+1) + 1 \equiv 1 \pmod 3
    \end{align*}
    Therefore, the possible remainders of $n^2$ when divided by $3$ are $0$ and $1$.
\end{solutions*}
